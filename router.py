...
class Router:
    ...
    def initialize_core_components(self):
        ...
        try:
            ...
            self.shared_api = WazuhApi(self.config_manager.get_wazuh_config())

            self.controllers['dashboard'] = DashboardController(api_client=self.shared_api)
            self.controllers['alerts']    = AlertsController(api_client=self.shared_api)
        ...
        try:
            ...
            def connect_signals():
                try:
                    ...
                    controller.export_completed.connect(view.on_export_completed)
                    controller.export_failed.connect(view.on_export_failed)
                    controller.report_generated.connect(view.on_report_generated)
    ...
    def cleanup(self):
        ...
        try:
            ...
            try:
                if hasattr(self, "shared_api"):
                    self.shared_api.close()
            except Exception as e:
                debug_logger.error(f"Error closing WazuhApi: {e}")
