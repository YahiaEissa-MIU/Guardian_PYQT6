...
class IncidentHistoryModel:
    ...
    def _get_cves_from_keywords(self, text):
        ...
        keyword_mappings = {
            'emotet': ['CVE-2017-11882', 'CVE-2018-0802', 'CVE-2018-4878'],
            'trickbot': ['CVE-2017-0144', 'CVE-2020-0796', 'CVE-2021-40444'],
            'qakbot': ['CVE-2021-40444', 'CVE-2021-42287', 'CVE-2021-42278'],
            'qbot': ['CVE-2021-40444', 'CVE-2021-42287'],
            'cobalt': ['CVE-2021-44228', 'CVE-2021-34527', 'CVE-2022-26134'],
            'cobaltstrike': ['CVE-2021-44228', 'CVE-2021-34527'],
            'mimikatz': ['CVE-2020-1472', 'CVE-2021-36942'],
            'lazarus': ['CVE-2021-44228', 'CVE-2017-0144'],
            'darkside': ['CVE-2021-34527', 'CVE-2019-19781'],
            'ryuk': ['CVE-2020-1472', 'CVE-2018-8453'],
            'conti': ['CVE-2020-0796', 'CVE-2021-34527'],
            'wannacry': ['CVE-2017-0144', 'CVE-2017-0145', 'CVE-2017-0146'],
            ...
            'hafnium': ['CVE-2021-26855', 'CVE-2021-26857', 'CVE-2021-26858'],
            'bluekeep': ['CVE-2019-0708'],
            'sigred': ['CVE-2020-1350'],
            'netlogon': ['CVE-2020-1472'],
            'remote code execution': ['CVE-2021-34527', 'CVE-2021-44228'],
            'privilege escalation': ['CVE-2021-1732', 'CVE-2020-0787'],
            'ransomware': ['CVE-2021-34527', 'CVE-2017-0144'],
            'fileless': ['CVE-2017-0199', 'CVE-2017-11882'],
            'powershell': ['CVE-2020-1472', 'CVE-2021-34527'],
            'lateral movement': ['CVE-2020-1472', 'CVE-2017-0144'],
        }
    ...
    def _get_cves_from_rule_mapping(self, rule_id):
        ...
        rule_cve_map = {
            ...
            "87101": ["CVE-2017-0143", "CVE-2017-0144"],
    ...
    def _get_cves_from_mitre_mapping(self, technique):
        ...
        technique_cve_map = {
            # Initial Access
            "T1190": ["CVE-2021-44228", "CVE-2021-26855", "CVE-2019-19781"],
            "T1133": ["CVE-2019-11510", "CVE-2018-13379"],

            # Execution
            "T1203": ["CVE-2021-40444", "CVE-2021-34527", "CVE-2017-11882"],
            "T1059": ["CVE-2020-1472"],
            ...
            "T1068": ["CVE-2020-0787", "CVE-2021-34527"],
            ...
            # Lateral Movement
            "T1021": ["CVE-2020-1472", "CVE-2019-0708"],
            "T1210": ["CVE-2017-0144", "CVE-2019-0708"],
        }
